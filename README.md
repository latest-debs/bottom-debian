...
[![Release](https://img.shields.io/github/v/release/latest-debs/bottom-debian)](https://github.com/latest-debs/bottom-debian/releases)
[![Build](https://github.com/latest-debs/bottom-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./bottom_*.deb
```

## Verify

```sh
apt-cache policy bottom
bottom --version
```
...
For issues with bottom itself, see
